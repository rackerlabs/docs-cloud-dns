...
html_title = 'Rackspace Managed DNS version 2.0 API Guide'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Managed DNS v2 API Guide'
...
htmlhelp_basename = 'docs-managed-dnsdoc'
...
latex_documents = [
  ...
  'Rackspace Managed DNS API Guide',
   'Rackspace', 'manual'),
]
...
texinfo_documents = [
  (master_doc, 'dns-cloud-dns', 'Rackspace Managed DNS API Docuemtnation',
