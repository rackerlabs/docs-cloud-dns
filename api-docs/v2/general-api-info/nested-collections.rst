...
By default, a nested collection is included in the listing of its parent resource. For 
example, listing record sets includes the ``records`` collection for each of the 
