...
There are record set operations to view information about the record sets for a specified
zone or across all zones.

If you wish to manage recordsets within a specific zone, uses the following operations:
