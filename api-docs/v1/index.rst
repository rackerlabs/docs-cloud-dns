...
=========================================================
Rackspace Cloud DNS API |contract version|
=========================================================
...
.. note::
   ...
   See :ref:`DNS propagation <cdns-dg-propagation>` for information about DNS
   propagation.

The following figure shows an overview of |service| infrastructure:
...
The |service| enables developers to view and manage domains, subdomains, and
