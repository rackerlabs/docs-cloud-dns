...
html_title = 'Rackspace Cloud DNS v1 API documentation'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Cloud DNS v1 API'
...
htmlhelp_basename = 'docs-cloud-dnsv1doc'
...
latex_documents = [
  (master_doc, 'RackspaceCloudDNSv1DeveloperDoc.tex',
  'Rackspace Cloud DNS v1 API Guide',
   'Rackspace', 'manual'),
]
...
man_pages = [
     (master_doc, 'Rackspace Cloud DNS v1 API documentation',
...
texinfo_documents = [
  (master_doc, 'docs-cloud-dns', 'Rackspace Cloud DNS API Documentation',
   'Rackspace', 'docs-cloud-dns', 'Learn about using the Cloud DNS service.',
   'Miscellaneous'),
]
