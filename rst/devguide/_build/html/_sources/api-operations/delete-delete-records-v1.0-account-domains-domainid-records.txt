...
=============================================================================
Delete Records -  Rackspace Cloud DNS Developer Guide
=============================================================================

Delete Records
~~~~~~~~~~~~~~~~~~~~~~~~~

`Request <delete-delete-records-v1.0-account-domains-domainid-records.html#request>`__
`Response <delete-delete-records-v1.0-account-domains-domainid-records.html#response>`__
...
|Name                      |Type                     |Description              |
+==========================+=========================+=========================+
|id1                       |xs:string *(Required)*   |ID for the first record. |
+--------------------------+-------------------------+-------------------------+
|id2                       |xs:string *(Required)*   |ID for the next record.  |
+--------------------------+-------------------------+-------------------------+
