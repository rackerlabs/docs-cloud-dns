...
=============================================================================
Import Domain -  Rackspace Cloud DNS Developer Guide
=============================================================================

Import Domain
~~~~~~~~~~~~~~~~~~~~~~~~~

`Request <post-import-domain-v1.0-account-domains-import.html#request>`__
`Response <post-import-domain-v1.0-account-domains-import.html#response>`__
...
|Name                      |Type                     |Description              |
+==========================+=========================+=========================+
|contentType               |xs:string *(Required)*   |The content type for the |
|                          |                         |bind file. Must be       |
|                          |                         |specified as "BIND_9".   |
+--------------------------+-------------------------+-------------------------+
|contents                  |xs:string *(Required)*   |The valid configuration  |
