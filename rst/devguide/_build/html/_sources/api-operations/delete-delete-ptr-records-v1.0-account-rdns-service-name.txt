...
=============================================================================
Delete Ptr Records -  Rackspace Cloud DNS Developer Guide
=============================================================================

Delete Ptr Records
~~~~~~~~~~~~~~~~~~~~~~~~~

`Request <delete-delete-ptr-records-v1.0-account-rdns-service-name.html#request>`__
`Response <delete-delete-ptr-records-v1.0-account-rdns-service-name.html#response>`__
...
|                          |                         |device.                  |
+--------------------------+-------------------------+-------------------------+
|ip                        |xs:string *(Required)*   |IP address for the       |
