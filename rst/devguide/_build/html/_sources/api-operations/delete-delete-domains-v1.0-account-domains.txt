...
=============================================================================
Delete Domains -  Rackspace Cloud DNS Developer Guide
=============================================================================

Delete Domains
~~~~~~~~~~~~~~~~~~~~~~~~~

`Request <delete-delete-domains-v1.0-account-domains.html#request>`__
`Response <delete-delete-domains-v1.0-account-domains.html#response>`__
...
|Name                      |Type                     |Description              |
+==========================+=========================+=========================+
|id1                       |xs:string *(Required)*   |The id for the first     |
|                          |                         |domain.                  |
+--------------------------+-------------------------+-------------------------+
|id2                       |xs:string *(Required)*   |The id for the next      |
|                          |                         |domain.                  |
+--------------------------+-------------------------+-------------------------+
