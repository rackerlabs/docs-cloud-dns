...
=============================================================================
Add Records -  Rackspace Cloud DNS Developer Guide
=============================================================================

Add Records
~~~~~~~~~~~~~~~~~~~~~~~~~

`Request <post-add-records-v1.0-account-domains-domainid-records.html#request>`__
`Response <post-add-records-v1.0-account-domains-domainid-records.html#response>`__
...
|Name                      |Type                     |Description              |
+==========================+=========================+=========================+
|type                      |xs:string *(Required)*   |The record type to add.  |
+--------------------------+-------------------------+-------------------------+
...
|                          |                         |A, and AAAA records must |
|                          |                         |be a valid IPv4 or IPv6  |
|                          |                         |IP address.              |
+--------------------------+-------------------------+-------------------------+
|priority                  |xs:string *(Required)*   |Required for MX and SRV  |
|                          |                         |records, but forbidden   |
|                          |                         |for other record types.  |
|                          |                         |If specified, must be an |
