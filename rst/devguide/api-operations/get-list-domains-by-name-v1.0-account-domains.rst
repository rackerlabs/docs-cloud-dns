...
=============================================================================
List Domains By Name -  Rackspace Cloud DNS Developer Guide
=============================================================================

List Domains By Name
~~~~~~~~~~~~~~~~~~~~~~~~~

`Request <get-list-domains-by-name-v1.0-account-domains.html#request>`__
`Response <get-list-domains-by-name-v1.0-account-domains.html#response>`__
...
|Name                      |Type                     |Description              |
+==========================+=========================+=========================+
|name                      |xs:string *(Required)*   |Name of the domain to    |
|                          |                         |find.                    |
+--------------------------+-------------------------+-------------------------+
