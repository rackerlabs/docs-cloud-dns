...
=============================================================================
List Domain Details Without Subdomains -  Rackspace Cloud DNS Developer Guide
=============================================================================

List Domain Details Without Subdomains
~~~~~~~~~~~~~~~~~~~~~~~~~

`Request <get-list-domain-details-without-subdomains-v1.0-account-domains-domainid.html#request>`__
`Response <get-list-domain-details-without-subdomains-v1.0-account-domains-domainid.html#response>`__
