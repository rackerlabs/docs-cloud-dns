...
=============================================================================
List Ptr Records -  Rackspace Cloud DNS Developer Guide
=============================================================================

List Ptr Records
~~~~~~~~~~~~~~~~~~~~~~~~~

`Request <get-list-ptr-records-v1.0-account-rdns-service-name.html#request>`__
`Response <get-list-ptr-records-v1.0-account-rdns-service-name.html#response>`__
