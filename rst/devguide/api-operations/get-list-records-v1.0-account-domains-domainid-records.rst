...
=============================================================================
List Records -  Rackspace Cloud DNS Developer Guide
=============================================================================

List Records
~~~~~~~~~~~~~~~~~~~~~~~~~

`Request <get-list-records-v1.0-account-domains-domainid-records.html#request>`__
`Response <get-list-records-v1.0-account-domains-domainid-records.html#response>`__
