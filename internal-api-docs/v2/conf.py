...
project = 'Rackspace Internal Managed DNS'
...
.. |service| replace:: Internal Managed DNS
.. |apiservice| replace:: Rackspace Internal Managed DNS API
.. |no changes| replace:: None for this release
.. |contract version| replace:: 2.0
.. |product name| replace:: Rackspace Internal Managed DNS
"""
...
html_title = 'Rackspace Internal Managed DNS version 2.0 API Guide'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Internal Managed DNS v2 API Guide'
...
htmlhelp_basename = 'docs-internal-managed-dnsdoc'
...
latex_documents = [
  (master_doc, 'docs-cloud-dns.tex',
  'Rackspace Internal Managed DNS API Guide',
   'Rackspace', 'manual'),
]
...
texinfo_documents = [
  (master_doc, 'dns-cloud-dns', 'Rackspace Managed DNS Internal API Docuemtnation',
   'Rackspace', 'docs-cloud-dns', 'Learn about using Managed DNS',
   'Miscellaneous'),
]
